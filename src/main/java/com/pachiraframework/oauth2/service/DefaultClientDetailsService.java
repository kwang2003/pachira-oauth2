...
public class DefaultClientDetailsService implements ClientDetailsService {
	...
	public ClientDetails loadClientByClientId(String clientId) throws ClientRegistrationException {
		...
		ResponseEntity<ExecuteResult<Client>> responseEntity = restTemplate.exchange("http://localhost:8080/api/party/clients/?client_id="+clientId, HttpMethod.GET, new HttpEntity<>(null), typeRef); 
